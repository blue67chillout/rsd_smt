...
VL_ATTR_COLD void VSMT_RTL_Testbench_LVT_DistributedMultiPortRAM__pi32___stl_sequent__TOP__SMT_RTL_Testbench__core__retirementRMT__regRMT__genblk1__DOT__body__0(VSMT_RTL_Testbench_LVT_DistributedMultiPortRAM__pi32* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                      VSMT_RTL_Testbench_LVT_DistributedMultiPortRAM__pi32___stl_sequent__TOP__SMT_RTL_Testbench__core__retirementRMT__regRMT__genblk1__DOT__body__0\n"); );
...
VL_ATTR_COLD void VSMT_RTL_Testbench_LVT_DistributedMultiPortRAM__pi32___ctor_var_reset(VSMT_RTL_Testbench_LVT_DistributedMultiPortRAM__pi32* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                      VSMT_RTL_Testbench_LVT_DistributedMultiPortRAM__pi32___ctor_var_reset\n"); );
    VSMT_RTL_Testbench__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    ...
    for (int __Vi0 = 0; __Vi0 < 2; ++__Vi0) {
        vlSelf->__PVT__wv[__Vi0] = VL_RAND_RESET_I(6);
    }
    for (int __Vi0 = 0; __Vi0 < 2; ++__Vi0) {
        vlSelf->__PVT__ra[__Vi0] = VL_RAND_RESET_I(6);
    }
    for (int __Vi0 = 0; __Vi0 < 2; ++__Vi0) {
        vlSelf->__PVT__rv[__Vi0] = VL_RAND_RESET_I(6);
    }
    for (int __Vi0 = 0; __Vi0 < 64; ++__Vi0) {
        vlSelf->debugValue[__Vi0] = VL_RAND_RESET_I(6);
    }
    for (int __Vi0 = 0; __Vi0 < 2; ++__Vi0) {
        for (int __Vi1 = 0; __Vi1 < 2; ++__Vi1) {
            vlSelf->__PVT__genblk1__DOT__rvBank[__Vi0][__Vi1] = VL_RAND_RESET_I(6);
        }
    }
    for (int __Vi0 = 0; __Vi0 < 2; ++__Vi0) {
    ...
    for (int __Vi0 = 0; __Vi0 < 64; ++__Vi0) {
        vlSelf->__PVT__genblk1__DOT__genblk1__BRA__0__KET____DOT__genblk1__BRA__0__KET____DOT__rBank__DOT__array[__Vi0] = VL_RAND_RESET_I(6);
    }
    ...
    for (int __Vi0 = 0; __Vi0 < 64; ++__Vi0) {
        vlSelf->__PVT__genblk1__DOT__genblk1__BRA__0__KET____DOT__genblk1__BRA__1__KET____DOT__rBank__DOT__array[__Vi0] = VL_RAND_RESET_I(6);
    }
    ...
    for (int __Vi0 = 0; __Vi0 < 64; ++__Vi0) {
        vlSelf->__PVT__genblk1__DOT__genblk1__BRA__1__KET____DOT__genblk1__BRA__0__KET____DOT__rBank__DOT__array[__Vi0] = VL_RAND_RESET_I(6);
    }
    ...
    for (int __Vi0 = 0; __Vi0 < 64; ++__Vi0) {
        vlSelf->__PVT__genblk1__DOT__genblk1__BRA__1__KET____DOT__genblk1__BRA__1__KET____DOT__rBank__DOT__array[__Vi0] = VL_RAND_RESET_I(6);
    }
