...
VL_ATTR_COLD void VSMT_RTL_Testbench_LVT_DistributedMultiPortRAM__pi38___ctor_var_reset(VSMT_RTL_Testbench_LVT_DistributedMultiPortRAM__pi38* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                      VSMT_RTL_Testbench_LVT_DistributedMultiPortRAM__pi38___ctor_var_reset\n"); );
    ...
    for (int __Vi0 = 0; __Vi0 < 5; ++__Vi0) {
        for (int __Vi1 = 0; __Vi1 < 2; ++__Vi1) {
            vlSelf->__PVT__genblk1__DOT__rvBank[__Vi0][__Vi1] = VL_RAND_RESET_I(8);
        }
    }
    for (int __Vi0 = 0; __Vi0 < 2; ++__Vi0) {
    ...
    for (int __Vi0 = 0; __Vi0 < 2; ++__Vi0) {
        vlSelf->__PVT__genblk1__DOT__lvt__DOT__wbReadAddr[__Vi0] = VL_RAND_RESET_I(4);
    }
    for (int __Vi0 = 0; __Vi0 < 2; ++__Vi0) {
        for (int __Vi1 = 0; __Vi1 < 2; ++__Vi1) {
    ...
    for (int __Vi0 = 0; __Vi0 < 5; ++__Vi0) {
        vlSelf->__PVT__genblk1__DOT__lvt__DOT__rbReadAddr[__Vi0] = VL_RAND_RESET_I(4);
    }
    for (int __Vi0 = 0; __Vi0 < 2; ++__Vi0) {
    ...
    for (int __Vi0 = 0; __Vi0 < 16; ++__Vi0) {
        vlSelf->__PVT__genblk1__DOT__genblk1__BRA__0__KET____DOT__genblk1__BRA__0__KET____DOT__rBank__DOT__array[__Vi0] = VL_RAND_RESET_I(8);
    }
    ...
    for (int __Vi0 = 0; __Vi0 < 16; ++__Vi0) {
        vlSelf->__PVT__genblk1__DOT__genblk1__BRA__0__KET____DOT__genblk1__BRA__1__KET____DOT__rBank__DOT__array[__Vi0] = VL_RAND_RESET_I(8);
    }
    ...
    for (int __Vi0 = 0; __Vi0 < 16; ++__Vi0) {
        vlSelf->__PVT__genblk1__DOT__genblk1__BRA__0__KET____DOT__genblk1__BRA__2__KET____DOT__rBank__DOT__array[__Vi0] = VL_RAND_RESET_I(8);
    }
    ...
    for (int __Vi0 = 0; __Vi0 < 16; ++__Vi0) {
        vlSelf->__PVT__genblk1__DOT__genblk1__BRA__0__KET____DOT__genblk1__BRA__3__KET____DOT__rBank__DOT__array[__Vi0] = VL_RAND_RESET_I(8);
    }
    ...
    for (int __Vi0 = 0; __Vi0 < 16; ++__Vi0) {
        vlSelf->__PVT__genblk1__DOT__genblk1__BRA__0__KET____DOT__genblk1__BRA__4__KET____DOT__rBank__DOT__array[__Vi0] = VL_RAND_RESET_I(8);
    }
    ...
    for (int __Vi0 = 0; __Vi0 < 16; ++__Vi0) {
        vlSelf->__PVT__genblk1__DOT__genblk1__BRA__1__KET____DOT__genblk1__BRA__0__KET____DOT__rBank__DOT__array[__Vi0] = VL_RAND_RESET_I(8);
    }
    ...
    for (int __Vi0 = 0; __Vi0 < 16; ++__Vi0) {
        vlSelf->__PVT__genblk1__DOT__genblk1__BRA__1__KET____DOT__genblk1__BRA__1__KET____DOT__rBank__DOT__array[__Vi0] = VL_RAND_RESET_I(8);
    }
    ...
    for (int __Vi0 = 0; __Vi0 < 16; ++__Vi0) {
        vlSelf->__PVT__genblk1__DOT__genblk1__BRA__1__KET____DOT__genblk1__BRA__2__KET____DOT__rBank__DOT__array[__Vi0] = VL_RAND_RESET_I(8);
    }
    ...
    for (int __Vi0 = 0; __Vi0 < 16; ++__Vi0) {
        vlSelf->__PVT__genblk1__DOT__genblk1__BRA__1__KET____DOT__genblk1__BRA__3__KET____DOT__rBank__DOT__array[__Vi0] = VL_RAND_RESET_I(8);
    }
    ...
    for (int __Vi0 = 0; __Vi0 < 16; ++__Vi0) {
        vlSelf->__PVT__genblk1__DOT__genblk1__BRA__1__KET____DOT__genblk1__BRA__4__KET____DOT__rBank__DOT__array[__Vi0] = VL_RAND_RESET_I(8);
    }
