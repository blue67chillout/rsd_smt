...
VL_INLINE_OPT void VSMT_RTL_Testbench_CommitStage___act_comb__TOP__SMT_RTL_Testbench__core__cmStage__0(VSMT_RTL_Testbench_CommitStage* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                VSMT_RTL_Testbench_CommitStage___act_comb__TOP__SMT_RTL_Testbench__core__cmStage__0\n"); );
...
VL_INLINE_OPT void VSMT_RTL_Testbench_CommitStage___nba_sequent__TOP__SMT_RTL_Testbench__core__cmStage__0(VSMT_RTL_Testbench_CommitStage* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                VSMT_RTL_Testbench_CommitStage___nba_sequent__TOP__SMT_RTL_Testbench__core__cmStage__0\n"); );
    VSMT_RTL_Testbench__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    if (VL_UNLIKELY((VL_LTS_III(32, 0x1f4U, vlSelfRef.__PVT__cycles)))) {
        VL_WRITEF_NX("Deadlock detected\n",0);
    }
    if (VL_UNLIKELY((((vlSelfRef.commit[0U] & (0U == (IData)(vlSelfRef.__PVT__phase))) 
                      & (IData)((vlSelfRef.alReadData
                                 [0U] >> 0x12U)))))) {
        VL_WRITEF_NX("An undefined or unsupported op is retired.\n",0);
    }
    if (VL_UNLIKELY((((vlSelfRef.commit[1U] & (0U == (IData)(vlSelfRef.__PVT__phase))) 
                      & (IData)((vlSelfRef.alReadData
                                 [1U] >> 0x12U)))))) {
        VL_WRITEF_NX("An undefined or unsupported op is retired.\n",0);
    }
    vlSelfRef.__PVT__cycles = (((IData)(vlSymsp->TOP__SMT_RTL_Testbench.__PVT__rst) 
                                | vlSelfRef.commit[0U])
                                ? 0U : ((IData)(1U) 
                                        + vlSelfRef.__PVT__cycles));
    vlSelfRef.__PVT__prevLastCommittedPC = vlSelfRef.__PVT__lastCommittedPC;
}

VL_INLINE_OPT void VSMT_RTL_Testbench_CommitStage___nba_comb__TOP__SMT_RTL_Testbench__core__cmStage__0(VSMT_RTL_Testbench_CommitStage* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                VSMT_RTL_Testbench_CommitStage___nba_comb__TOP__SMT_RTL_Testbench__core__cmStage__0\n"); );
    VSMT_RTL_Testbench__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
    CData/*0:0*/ __Vtask_DecideCommit__0__toRecoveryPhase;
