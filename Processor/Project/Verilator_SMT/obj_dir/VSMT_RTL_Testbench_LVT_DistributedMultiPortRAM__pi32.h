...
#ifndef VERILATED_VSMT_RTL_TESTBENCH_LVT_DISTRIBUTEDMULTIPORTRAM__PI32_H_
#define VERILATED_VSMT_RTL_TESTBENCH_LVT_DISTRIBUTEDMULTIPORTRAM__PI32_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) VSMT_RTL_Testbench_LVT_DistributedMultiPortRAM__pi32 final : public VerilatedModule {
  public:
    ...
    VL_IN8(__PVT__wv[2],5,0);
    VL_IN8(__PVT__ra[2],5,0);
    VL_OUT8(__PVT__rv[2],5,0);
    VlUnpacked<CData/*5:0*/, 64> debugValue;
    VlUnpacked<VlUnpacked<CData/*5:0*/, 2>, 2> __PVT__genblk1__DOT__rvBank;
    VlUnpacked<CData/*0:0*/, 2> __PVT__genblk1__DOT__lvi;
    VlUnpacked<CData/*0:0*/, 2> __PVT__genblk1__DOT__lvo;
    ...
    VlUnpacked<VlUnpacked<CData/*0:0*/, 2>, 2> __PVT__genblk1__DOT__lvt__DOT__rbReadValue;
    ...
    VlUnpacked<CData/*5:0*/, 64> __PVT__genblk1__DOT__genblk1__BRA__0__KET____DOT__genblk1__BRA__0__KET____DOT__rBank__DOT__array;
    VlUnpacked<CData/*5:0*/, 64> __PVT__genblk1__DOT__genblk1__BRA__0__KET____DOT__genblk1__BRA__1__KET____DOT__rBank__DOT__array;
    VlUnpacked<CData/*5:0*/, 64> __PVT__genblk1__DOT__genblk1__BRA__1__KET____DOT__genblk1__BRA__0__KET____DOT__rBank__DOT__array;
    VlUnpacked<CData/*5:0*/, 64> __PVT__genblk1__DOT__genblk1__BRA__1__KET____DOT__genblk1__BRA__1__KET____DOT__rBank__DOT__array;

    // INTERNAL VARIABLES
    VSMT_RTL_Testbench__Syms* const vlSymsp;

    // CONSTRUCTORS
    VSMT_RTL_Testbench_LVT_DistributedMultiPortRAM__pi32(VSMT_RTL_Testbench__Syms* symsp, const char* v__name);
    ~VSMT_RTL_Testbench_LVT_DistributedMultiPortRAM__pi32();
    VL_UNCOPYABLE(VSMT_RTL_Testbench_LVT_DistributedMultiPortRAM__pi32);
