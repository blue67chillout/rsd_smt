...
VL_INLINE_OPT void VSMT_RTL_Testbench_DistributedMultiPortRAM__pi15___nba_sequent__TOP__SMT_RTL_Testbench__core__destinationRAM__dstRAM__0(VSMT_RTL_Testbench_DistributedMultiPortRAM__pi15* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                    VSMT_RTL_Testbench_DistributedMultiPortRAM__pi15___nba_sequent__TOP__SMT_RTL_Testbench__core__destinationRAM__dstRAM__0\n"); );
    VSMT_RTL_Testbench__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
    CData/*7:0*/ __VdlyVal__debugValue__v0;
    ...
    CData/*7:0*/ __VdlyVal__debugValue__v1;
