...
VL_ATTR_COLD void VSMT_RTL_Testbench_BlockMultiBankRAM__E400_EB1_W1___stl_sequent__TOP__SMT_RTL_Testbench__core__memoryDependencyPredictor__mdt__0(VSMT_RTL_Testbench_BlockMultiBankRAM__E400_EB1_W1* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                    VSMT_RTL_Testbench_BlockMultiBankRAM__E400_EB1_W1___stl_sequent__TOP__SMT_RTL_Testbench__core__memoryDependencyPredictor__mdt__0\n"); );
...
VL_ATTR_COLD void VSMT_RTL_Testbench_BlockMultiBankRAM__E400_EB1_W1___stl_comb__TOP__SMT_RTL_Testbench__core__memoryDependencyPredictor__mdt__0(VSMT_RTL_Testbench_BlockMultiBankRAM__E400_EB1_W1* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                    VSMT_RTL_Testbench_BlockMultiBankRAM__E400_EB1_W1___stl_comb__TOP__SMT_RTL_Testbench__core__memoryDependencyPredictor__mdt__0\n"); );
    VSMT_RTL_Testbench__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void VSMT_RTL_Testbench_BlockMultiBankRAM__E400_EB1_W1___ctor_var_reset(VSMT_RTL_Testbench_BlockMultiBankRAM__E400_EB1_W1* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                    VSMT_RTL_Testbench_BlockMultiBankRAM__E400_EB1_W1___ctor_var_reset\n"); );
    VSMT_RTL_Testbench__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    ...
    for (int __Vi0 = 0; __Vi0 < 1; ++__Vi0) {
        vlSelf->__PVT__wa[__Vi0] = VL_RAND_RESET_I(10);
    }
    for (int __Vi0 = 0; __Vi0 < 1; ++__Vi0) {
        vlSelf->__PVT__wv[__Vi0] = VL_RAND_RESET_I(1);
    }
    for (int __Vi0 = 0; __Vi0 < 2; ++__Vi0) {
        vlSelf->__PVT__ra[__Vi0] = VL_RAND_RESET_I(10);
    }
    for (int __Vi0 = 0; __Vi0 < 2; ++__Vi0) {
    ...
    for (int __Vi0 = 0; __Vi0 < 2; ++__Vi0) {
        vlSelf->__PVT__rvReg[__Vi0] = VL_RAND_RESET_I(1);
    }
    ...
    for (int __Vi0 = 0; __Vi0 < 2; ++__Vi0) {
        vlSelf->__PVT__genblk1__DOT__rBank__DOT__waBank[__Vi0] = VL_RAND_RESET_I(10);
    }
    for (int __Vi0 = 0; __Vi0 < 2; ++__Vi0) {
        vlSelf->__PVT__genblk1__DOT__rBank__DOT__raBank[__Vi0] = VL_RAND_RESET_I(10);
    }
    for (int __Vi0 = 0; __Vi0 < 2; ++__Vi0) {
        vlSelf->__PVT__genblk1__DOT__rBank__DOT__rvBank[__Vi0] = VL_RAND_RESET_I(1);
    }
    for (int __Vi0 = 0; __Vi0 < 2; ++__Vi0) {
        vlSelf->__PVT__genblk1__DOT__rBank__DOT__wvBank[__Vi0] = VL_RAND_RESET_I(1);
    }
    for (int __Vi0 = 0; __Vi0 < 2; ++__Vi0) {
        vlSelf->__PVT__genblk1__DOT__rBank__DOT__weBank[__Vi0] = VL_RAND_RESET_I(1);
    }
    for (int __Vi0 = 0; __Vi0 < 2; ++__Vi0) {
        vlSelf->__PVT__genblk1__DOT__rBank__DOT__raReg[__Vi0] = VL_RAND_RESET_I(10);
    }
    vlSelf->genblk1__DOT__rBank__DOT____Vcellout__genblk2__BRA__0__KET____DOT__rBank____pinNumber6 = VL_RAND_RESET_I(1);
    vlSelf->genblk1__DOT__rBank__DOT____Vcellout__genblk2__BRA__1__KET____DOT__rBank____pinNumber6 = VL_RAND_RESET_I(1);
    ...
    for (int __Vi0 = 0; __Vi0 < 512; ++__Vi0) {
        vlSelf->__PVT__genblk1__DOT__rBank__DOT__genblk2__BRA__0__KET____DOT__rBank__DOT__array[__Vi0] = VL_RAND_RESET_I(1);
    }
    for (int __Vi0 = 0; __Vi0 < 512; ++__Vi0) {
        vlSelf->__PVT__genblk1__DOT__rBank__DOT__genblk2__BRA__1__KET____DOT__rBank__DOT__array[__Vi0] = VL_RAND_RESET_I(1);
    }
}
