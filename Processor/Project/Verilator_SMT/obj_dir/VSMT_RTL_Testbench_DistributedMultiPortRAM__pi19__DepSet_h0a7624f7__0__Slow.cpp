...
VL_ATTR_COLD void VSMT_RTL_Testbench_DistributedMultiPortRAM__pi19___ctor_var_reset(VSMT_RTL_Testbench_DistributedMultiPortRAM__pi19* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                    VSMT_RTL_Testbench_DistributedMultiPortRAM__pi19___ctor_var_reset\n"); );
