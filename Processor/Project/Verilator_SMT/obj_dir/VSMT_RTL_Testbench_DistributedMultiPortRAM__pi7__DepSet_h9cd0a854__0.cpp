...
VL_INLINE_OPT void VSMT_RTL_Testbench_DistributedMultiPortRAM__pi7___nba_sequent__TOP__SMT_RTL_Testbench__core__rmt_wat__regRMT__0(VSMT_RTL_Testbench_DistributedMultiPortRAM__pi7* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                    VSMT_RTL_Testbench_DistributedMultiPortRAM__pi7___nba_sequent__TOP__SMT_RTL_Testbench__core__rmt_wat__regRMT__0\n"); );
