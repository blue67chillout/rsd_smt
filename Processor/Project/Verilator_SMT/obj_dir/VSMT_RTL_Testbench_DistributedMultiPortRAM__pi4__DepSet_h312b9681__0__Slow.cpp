...
VL_ATTR_COLD void VSMT_RTL_Testbench_DistributedMultiPortRAM__pi4___ctor_var_reset(VSMT_RTL_Testbench_DistributedMultiPortRAM__pi4* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                    VSMT_RTL_Testbench_DistributedMultiPortRAM__pi4___ctor_var_reset\n"); );
