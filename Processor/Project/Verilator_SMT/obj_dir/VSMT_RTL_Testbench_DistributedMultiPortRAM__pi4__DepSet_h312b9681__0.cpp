...
VL_INLINE_OPT void VSMT_RTL_Testbench_DistributedMultiPortRAM__pi4___nba_sequent__TOP__SMT_RTL_Testbench__core__activeList__execState__0(VSMT_RTL_Testbench_DistributedMultiPortRAM__pi4* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                    VSMT_RTL_Testbench_DistributedMultiPortRAM__pi4___nba_sequent__TOP__SMT_RTL_Testbench__core__activeList__execState__0\n"); );
    ...
    CData/*0:0*/ __VdlyVal__debugValue__v7;
