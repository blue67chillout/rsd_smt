...
VL_INLINE_OPT void VSMT_RTL_Testbench_BlockMultiBankRAM__E400_EB1_W1___eval_initial__TOP__SMT_RTL_Testbench__core__memoryDependencyPredictor__mdt(VSMT_RTL_Testbench_BlockMultiBankRAM__E400_EB1_W1* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                    VSMT_RTL_Testbench_BlockMultiBankRAM__E400_EB1_W1___eval_initial__TOP__SMT_RTL_Testbench__core__memoryDependencyPredictor__mdt\n"); );
    VSMT_RTL_Testbench__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__PVT__unnamedblk1__DOT__i = 0U;
    while (VL_GTS_III(32, 0x400U, vlSelfRef.__PVT__unnamedblk1__DOT__i)) {
        vlSelfRef.debugValue[(0x3ffU & vlSelfRef.__PVT__unnamedblk1__DOT__i)] = 0U;
...
VL_INLINE_OPT void VSMT_RTL_Testbench_BlockMultiBankRAM__E400_EB1_W1___act_comb__TOP__SMT_RTL_Testbench__core__memoryDependencyPredictor__mdt__0(VSMT_RTL_Testbench_BlockMultiBankRAM__E400_EB1_W1* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                    VSMT_RTL_Testbench_BlockMultiBankRAM__E400_EB1_W1___act_comb__TOP__SMT_RTL_Testbench__core__memoryDependencyPredictor__mdt__0\n"); );
    VSMT_RTL_Testbench__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    ...
    {
        while (VL_GTS_III(32, 1U, vlSelfRef.__PVT__genblk1__DOT__rBank__DOT__unnamedblk2__DOT__unnamedblk3__DOT__i)) {
            if ((((0U >= (1U & vlSelfRef.__PVT__genblk1__DOT__rBank__DOT__unnamedblk2__DOT__unnamedblk3__DOT__i)) 
                  && vlSelfRef.__PVT__we[(1U & vlSelfRef.__PVT__genblk1__DOT__rBank__DOT__unnamedblk2__DOT__unnamedblk3__DOT__i)]) 
                 & (~ ((0U >= (1U & vlSelfRef.__PVT__genblk1__DOT__rBank__DOT__unnamedblk2__DOT__unnamedblk3__DOT__i))
...
VL_INLINE_OPT void VSMT_RTL_Testbench_BlockMultiBankRAM__E400_EB1_W1___nba_sequent__TOP__SMT_RTL_Testbench__core__memoryDependencyPredictor__mdt__0(VSMT_RTL_Testbench_BlockMultiBankRAM__E400_EB1_W1* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                    VSMT_RTL_Testbench_BlockMultiBankRAM__E400_EB1_W1___nba_sequent__TOP__SMT_RTL_Testbench__core__memoryDependencyPredictor__mdt__0\n"); );
    VSMT_RTL_Testbench__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
    CData/*0:0*/ __VdlyVal__rvReg__v0;
    __VdlyVal__rvReg__v0 = 0;
    CData/*0:0*/ __VdlyVal__rvReg__v1;
    __VdlyVal__rvReg__v1 = 0;
    CData/*0:0*/ __VdlyVal__debugValue__v0;
    __VdlyVal__debugValue__v0 = 0;
    SData/*9:0*/ __VdlyDim0__debugValue__v0;
    __VdlyDim0__debugValue__v0 = 0;
    CData/*0:0*/ __VdlySet__debugValue__v0;
    __VdlySet__debugValue__v0 = 0;
    SData/*9:0*/ __VdlyVal__genblk1__DOT__rBank__DOT__raReg__v0;
    __VdlyVal__genblk1__DOT__rBank__DOT__raReg__v0 = 0;
    SData/*9:0*/ __VdlyVal__genblk1__DOT__rBank__DOT__raReg__v1;
    __VdlyVal__genblk1__DOT__rBank__DOT__raReg__v1 = 0;
    CData/*0:0*/ __VdlyVal__genblk1__DOT__rBank__DOT__genblk2__BRA__0__KET____DOT__rBank__DOT__array__v0;
    __VdlyVal__genblk1__DOT__rBank__DOT__genblk2__BRA__0__KET____DOT__rBank__DOT__array__v0 = 0;
    SData/*8:0*/ __VdlyDim0__genblk1__DOT__rBank__DOT__genblk2__BRA__0__KET____DOT__rBank__DOT__array__v0;
    ...
    CData/*0:0*/ __VdlyVal__genblk1__DOT__rBank__DOT__genblk2__BRA__1__KET____DOT__rBank__DOT__array__v0;
    __VdlyVal__genblk1__DOT__rBank__DOT__genblk2__BRA__1__KET____DOT__rBank__DOT__array__v0 = 0;
    SData/*8:0*/ __VdlyDim0__genblk1__DOT__rBank__DOT__genblk2__BRA__1__KET____DOT__rBank__DOT__array__v0;
    ...
    if (vlSelfRef.__PVT__genblk1__DOT__rBank__DOT__weBank
        ...
        __VdlyDim0__genblk1__DOT__rBank__DOT__genblk2__BRA__0__KET____DOT__rBank__DOT__array__v0 
            = (0x1ffU & (vlSelfRef.__PVT__genblk1__DOT__rBank__DOT__waBank
                         [0U] >> 1U));
    ...
    vlSelfRef.genblk1__DOT__rBank__DOT____Vcellout__genblk2__BRA__0__KET____DOT__rBank____pinNumber6 
        ...
        [(0x1ffU & (vlSelfRef.__PVT__genblk1__DOT__rBank__DOT__raBank
                    [0U] >> 1U))];
...
VL_INLINE_OPT void VSMT_RTL_Testbench_BlockMultiBankRAM__E400_EB1_W1___nba_comb__TOP__SMT_RTL_Testbench__core__memoryDependencyPredictor__mdt__0(VSMT_RTL_Testbench_BlockMultiBankRAM__E400_EB1_W1* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                    VSMT_RTL_Testbench_BlockMultiBankRAM__E400_EB1_W1___nba_comb__TOP__SMT_RTL_Testbench__core__memoryDependencyPredictor__mdt__0\n"); );
    VSMT_RTL_Testbench__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__PVT__genblk1__DOT__rBank__DOT__weBank[0U] = 0U;
